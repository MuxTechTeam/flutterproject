...
class _SellerHomePageState extends State<SellerHomePage> {
  ...
  bList(DocumentSnapshot snapshot) {
                    ...
                    onPressed: () async {
                      ...
                      try {
                        FirebaseFirestore.instance
                          ...
                          'Lawyer Email': snapshot['Lawyer Email'],
  ...
  onGoingbList(DocumentSnapshot snapshot) {
  ...
  onCompletedbList(DocumentSnapshot snapshot) {
      ...
      builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            return bList(snapshot.data.docs[index]);
          },
        );
      },
    );
    ...
    return StreamBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
        ...
        return ListView.builder(
          itemCount: snapshot.data.docs.length,
          itemBuilder: (context, index) {
            return onGoingbList(snapshot.data.docs[index]);
          },
        );
      },
    );
    ...
    return StreamBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
        ...
        return ListView.builder(
          itemCount: snapshot.data.docs.length,
          itemBuilder: (context, index) {
            return onCompletedbList(snapshot.data.docs[index]);
          },
        );
      },
    );
