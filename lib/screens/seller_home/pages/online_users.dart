...
Stream<dynamic> dataFunct() {
   var mydata =  _firestore.collection('notifications').doc(loggedInUser.email).collection('notifications').snapshots();
return mydata;
}
      ...
      child: InkWell(
        onTap: (){
          //print(" its from navigation button ${sender}");
           ...
           isMe ? null: Navigator.pushNamed(context, ChatScreen.id, arguments:sender);
        },
              child: Column(
          crossAxisAlignment:
