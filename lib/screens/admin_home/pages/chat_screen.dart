    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          ...
          children: <Widget>[
            MessageStream(receiver: receiverEmail,),
            Container(
                  ...
                  FlatButton(
                    onPressed: () {
                     ...
                     // receiver
                      ...
                      .doc(receiverEmail)
                     // receiver
                      .collection(loggedInUser.email).add(
                        {
                          'text': messageText.toString(),
                          'sender': loggedInUser.email.toString(),
                          'receiver': receiverEmail,
                      ...
                      .doc(receiverEmail)
                     // receiver
                      .collection('notifications').doc(loggedInUser.email).set(
          ...
          Row(
            ...
            children: isMe
                ? [
                    ...
                    CircleAvatar(
                      backgroundColor:
                          isMe ? Colors.grey : Colors.redAccent,
