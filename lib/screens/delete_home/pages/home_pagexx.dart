...
// print(position.latitude.toString());
  ...
  void initState() {
    ...
    // Timer.run(() => _showAlert(context));
     //Timer.run(() =>_onBasicAlertPressed(context));

     // Timer.run(() => _onBasicWaitingAlertPressed(context));
       Timer.run(() =>_onAlertButtonPressed(context));
  }
...
// Alert with single button.
  _onAlertButtonPressed(context) {
    Alert(
      ...
      title: "DELETE ALERT",
      desc: "Your Account is DELETED. Due to violation of TOS.",
      buttons: [
        DialogButton(
          child: Text(
            "OK",
  ...
  _onCustomAnimationAlertPressed(context) {
    Alert(
      ...
      closeIcon:SizedBox(),
      title: "DELETE ALERT",
      desc: "Contact Support for more details.",
